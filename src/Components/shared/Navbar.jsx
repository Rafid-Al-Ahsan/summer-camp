...
import { Link, useLocation } from 'react-router-dom'; //for highlighting active route
                ...
                <div className="navbar text-white">
                    <div className="navbar-start">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                                ...
                                <li><Link to="/classespage" className="active">Classes</Link></li>
                                <li><Link to="/instructorpage" className="active">Instructor</Link></li>
                                <li><Link to="/dashboard" className="active">Dashboard</Link></li>
                                { user && <li className='active'><Link to="/dashboard">Dashboard</Link></li>}
                                { user && <li className='active'><Link to="/enrolled">Enrolled Classes</Link></li>}
                                <li>
                                <Link to="">
                    ...
                    <div className="navbar-center hidden lg:flex">
                        <ul className="menu menu-horizontal px-1">
                            ...
                            <li className='font-bold text-lg'><Link to="/classespage">Classes</Link></li>
                            <li className='font-bold text-lg'><Link to="/instructorpage">Instructors </Link></li>
                            { user && <li className='font-bold text-lg'><Link to="/dashboard">Dashboard</Link></li>}
                            { user && <li className='font-bold text-lg'><Link to="/enrolled">Enrolled Classes</Link></li>}
                            {user && <li>
