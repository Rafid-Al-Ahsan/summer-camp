        ...
        <div>
            <div className="hero min-h-screen bg-base-200">
                <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    ...
                    <button onClick={handleGoogleSignIn} className='btn bg-white mb-5 text-black m-auto w-[85%]'>
                        <Icon icon="flat-color-icons:google" color="white" width="34" height="34" /> Login using Google
                    </button>
                </div>
            </div>
        </div>
